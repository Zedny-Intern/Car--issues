...
RAG_DATA_STATIC_DIR = BASE_DIR.parent / 'data' / 'static'
RAG_DATA_UPLOADS_DIR = BASE_DIR.parent / 'data' / 'uploads'
RAG_EXTRACTED_IMAGES_DIR = BASE_DIR.parent / 'data' / 'extracted_images'
RAG_DATA_DIR = env('RAG_DATA_DIR', default=BASE_DIR.parent / 'rag data')  # Existing car manuals
RAG_FAISS_DB_DIR = BASE_DIR / 'faiss_db'

# Embedding Models (free, local)
# Embedding Models (free, local)
TEXT_EMBEDDING_MODEL = 'all-MiniLM-L6-v2'  # 384 dimensions
...
USE_GROQ = env('USE_GROQ', default=False)
